...
*/
// obiettivo è riempire l'oggetto eyecolor, nello specifico si devono riempire gli array []con i nomi dei personaggi corrispondenti a quei colori.
...
let crewMass = 0;
let contatore = 0;
while (contatore <= starWarsCharacters.length - 1) {
...
/* --EXTRA-- ESERCIZIO 9
  Utilizzando gli elementi presenti nell'array "femaleCharacters" rimuovi dall'array "charactersNames" le stringhe corrispondenti a
  personaggi con lo stesso nome.
  Una volta fatto crea un console.log per controllare la proprietà length di "charactersNames"
